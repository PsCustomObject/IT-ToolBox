...
<#
	...
	.PARAMETER UserName
		A string representing the username to use for authentication with the remote Exchange server.
	
	.PARAMETER UserPassword
		A clear text string representing the password to use for authentication with the remote Exchange server.
	
	.PARAMETER SecurePassword
		A securestring object representing the password to user for authentication with the remote Exchange server.
...
#>
	...
	[OutputType([object], ParameterSetName = 'UserNameSecurePassword')]
	[OutputType([object])]
	param
	(
		...
		[Parameter(ParameterSetName = 'UserNameSecurePassword',
				   Mandatory = $true)]
